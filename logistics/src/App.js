...
function App() {
  ...
  const homeUrl = "https://foodnet.com.ng/";
  const clientRootUrl = "https://amadurs.foodnet.com.ng/";
  ...
  return (
      <div className = "container">
        <Router>
          ...
          <Sidebar myClass = {myClass} closeSidebar = {closeSidebar} clientRootUrl = {clientRootUrl} adminEmail = {adminEmail} imagesRootUrl = {imagesRootUrl} />
          <ScrollToTop />
          <Switch>
            <Route path = "/" exact = {true} component = {()=><Home apiRootUrl = {apiRootUrl} token = {token} requireAuth = {requireAuth} />}/>
            <Route path = "/login" component = { ()=><Login apiRootUrl = {apiRootUrl} clientRootUrl = {clientRootUrl}  token = {token} errorMessage = {errorMessage} verifyAuth = {verifyAuth} imagesRootUrl = {imagesRootUrl} />} />
          ...
          <Route path = "/order/:orderId" exact = {true} component = {({match})=><OrderDetails apiRootUrl = {apiRootUrl} clientRootUrl = {clientRootUrl} token = {token} requireAuth = {requireAuth} errorMessage = {errorMessage} match = {match} title = {title} homeUrl = {homeUrl} imagesRootUrl = {imagesRootUrl} />} />
