...
function OrderDetails({apiRootUrl,clientRootUrl,token,requireAuth,match,errorMessage,title,homeUrl,imagesRootUrl}) {
        ...
        <Fragment>
            ...
            <main>
                <div className = "main__container" ref={componentRef}>
                    <img src = {`${imagesRootUrl}images/foodnet-black.png`} style = {{width:'200px', float:'right'}} alt = "" />
