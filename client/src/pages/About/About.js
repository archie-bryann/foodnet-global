...
function About({title,apiRootUrl,clientRootUrl, match,loggedInStatus, cartNum, token, imagesRootUrl}) {
    ...
    return (
        <React.Fragment>
            ...
            <div className = "small-container single-product">
                <div className = "row">
                    <div className = "col-2">
                        <img src = {`${imagesRootUrl}images/about.png`} className = "img-style curve" style={{objectFit:'cover'}} />
                    </div>
                    <div className = "col-2">
                        <h2>About Us</h2><br />
