...
function CategoryDetails({title,apiRootUrl, clientRootUrl ,match, loggedInStatus, cartNum, token, errorMessage, imagesRootUrl}) {
    ...
    return (
        <React.Fragment>
            ...
            <Products products = {products} apiRootUrl = {apiRootUrl}>
                <br />
                {/* // correct this // */}
                <div className = "cat-cover" style = {{background:`url('${apiRootUrl}uploads/${category.image}') right 20px bottom 0px`,}}>
