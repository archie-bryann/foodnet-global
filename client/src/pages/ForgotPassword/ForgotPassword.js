...
function ForgotPassword({title,clientRootUrl,apiRootUrl,loggedInStatus,verifyAuth,token,errorMessage, imagesRootUrl}) {
    ...
    return (
        <React.Fragment>
            {verifyAuth()}
            {loading&&<Loader/>}
            <Header title = {title} clientRootUrl = {clientRootUrl} loggedInStatus = {loggedInStatus} token = {token} imagesRootUrl = {imagesRootUrl} />
            <div className = "account-page">
                <div className = "container">
                    <div className = "row">
                        <div className = "col-2">
                            <img  src = {`${clientRootUrl}images/cover.png`} className = "img-style __cover" alt = "" />
                        </div>
