...
function NavBar({title, clientRootUrl, loggedInStatus, match, cartNum, token,imagesRootUrl}) {
    ...
    return (
        <div className = "navbar">
            <div className = "logo">
                ...
                {/* <h1 className = "__title" style = {{fontSize:'23px'}}>{title}</h1> */}
                <img src = {`${imagesRootUrl}images/foodnet.png`} className = "__img" width="157px" />              
                </Link>
            </div>
            ...
            {/* <UserContext.Consumer>
                {
                    loggedIn => {
                        (loggedIn) && (
                            ...
                            {/* {
                                (token) && (
                                <Link to="/logout" className = "link c"><i className = "fa fa-sign-out" style = {{fontSize:'23px', marginLeft:'15px'}}></i></Link>
                                )
                            } */}
