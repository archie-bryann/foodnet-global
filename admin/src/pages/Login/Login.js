...
function Login({apiRootUrl, clientRootUrl, errorMessage, verifyAuth, imagesRootUrl}) {
    ...
    function login(e) {
        ...
        if(username.trim() === '' || password.trim() === '') {
            ...
            setLoading(true);
            axios.post(`${apiRootUrl}admin/login`,{
                username,
                password
            }).then(({data})=>{
                setLoading(false);
    ...
    return (
        <Fragment>
            ...
            {loading&&<Loader />}
            {redr&&<Redirect to = "/"/>}
            <div className = "hero" style = {{backgroundImage:`linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(${imagesRootUrl}/images/banner.jpg)`}}>
                <div className = "form-box">
                    ...
                    <div className = "social-icons">
                        <img src = {`${imagesRootUrl}images/fb.png`} />
                        <img src = {`${imagesRootUrl}images/tw.png`} />
                        <img src = {`${imagesRootUrl}images/gp.png`} />
                    </div>
