...
function App() {
  ...
  const clientRootUrl = "https://admin.foodnet.com.ng/";
  ...
  return (
    <div className = "container">
      <Router>
        ...
        <Sidebar  myClass = {myClass} closeSidebar = {closeSidebar} clientRootUrl = {clientRootUrl} imagesRootUrl = {imagesRootUrl} />
        <ScrollToTop />
        <Switch>
